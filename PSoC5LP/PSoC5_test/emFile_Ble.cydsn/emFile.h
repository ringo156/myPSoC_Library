...
/* VVSK Start - SPI block definitions */
#define UDB_SPI_BLOCK         0u
#define SCB_SPI_BLOCK         1u

#define SPI_BLOCK_USED        UDB_SPI_BLOCK
    
#define SCB_SPI_OVERSAMPLING_FACTOR_GUI   6u
